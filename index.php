...
<body>
    <div class="container">
        <div class="row">
            <nav class="navbar-expand-lg navbar-dark bg-primary col-12">
                <a class="navbar-brand" href="#">SISTEMA WEB</a>
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown"
                       aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="collapse navbar-collapse" id ="navbarNavDropdopwn">
                    <ul class="navbar-nav">
        ...
        <div class="row">
            <div class="card mb-3 col-12">
                <div class="card-body">
                    <h5 class="card-tittle">Cadastrar - Agendamento de Potenciais Clientes</h5>
                    ...
                    <p>
                        <form method="post" action="controller/ControllerCadastro.php?funcao=cadastro" id="form" name="form">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control"required name="txtOrigem">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Obsrvação</label>
